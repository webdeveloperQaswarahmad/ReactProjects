          ...
          <div className="col-md-7  mx-auto">
            <div className="  ">
              <div className="col-md-10  mx-auto ">
                <div>
                  <h4 className="text-center text-dark  mb-1">
                    Add User Here
                  </h4>
                  <Form className="w-50 mx-auto h-100  ">
                    <Form.Group
                    ...
                    >
                      ...
                      <Form.Control
                        ...
                        name="name"
                        value={kyc}
                        placeholder="Here Only Enter Yes or No"
                        onChange={(e) => {
                    ...
                    >
                      ...
                      <Form.Control
                        ...
                        name="rating"
                        value={subscription}
                        placeholder="Subscriptoin Enter Yes or No"
                        onChange={(e) => {
